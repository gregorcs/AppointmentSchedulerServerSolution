...
namespace AppointmentSchedulerServer.Repositories
{
    public class SqlQueries
    {
        ...
        //query strings
        public static readonly string QUERY_SELECT_BY_EMAIL_AND_PASSWORD = "SELECT * FROM " + TABLE_ACCOUNTS + " WHERE " + COLUMN_EMAIL + " = " + "@Email";
        public static readonly string QUERY_SAVE_ACCOUNT = "INSERT INTO " + TABLE_ACCOUNTS + "(" + COLUMN_USERNAME + ", " + COLUMN_PASSWORD + ", " + COLUMN_EMAIL + ") OUTPUT Inserted.PK_Account_Id VALUES (@Username, @Password, @Email)";
        public static readonly string FIND_BY_ID = "SELECT * FROM " + TABLE_ACCOUNTS + " WHERE " + COLUMN_ACCOUNT_ID + " = " + "@Id";
